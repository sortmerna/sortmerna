...
main() {
    ...
    # check RocksDB - part of the asset
    echo "Testing: ls -lrt $ROCKSDB_INCLUDE_DIR/rocksdb"
    ls -lrt $ROCKSDB_INCLUDE_DIR/rocksdb
    echo "Testing: ls -lrt /opt/rocksdb"
    ls -lrt $ROCKSDB_LIB_DIR
    ...
    cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DWITH_TESTS=0 -DSRC_RAPIDJSON=1 \
          -DSET_ROCKSDB=1 -DROCKSDB_INCLUDE_DIR=$ROCKSDB_INCLUDE_DIR -DROCKSDB_LIB_RELEASE=$ROCKSDB_LIB_DIR ../..
    popd
